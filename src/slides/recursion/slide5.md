...
<div class="flex-col">
  ...
  <div v-click class="code-block">
    ...
    <span style="color:#0e6ead;">int</span> <span style="color:#2d7a00;">power</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">base</span>, <span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">exp</span>) {<br>
    ...
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#0e6ead;">base</span> * <span style="color:#2d7a00;">power</span>(<span style="color:#0e6ead;">base</span>, <span style="color:#0e6ead;">exp</span> - <span style="color:#b45309;">1</span>);</span>
    }
  </div>
  ...
  <div v-click class="card-green" style="font-size:.75rem;">
    ...
    <div style="margin-top:6px;display:flex;flex-direction:column;gap:3px;">
      ...
      <div><span class="pill pill-green">str[0] == '\0'</span> for strings/arrays</div>
    </div>
  </div>
</div>
...
<div class="flex-col">
  ...
  <div v-click class="code-block">
    ...
    <span style="padding-left:40px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#b45309;">1</span>;</span>
    <span style="padding-left:20px;display:block;background:#ebf8ff;border-left:3px solid var(--blue);"><span style="color:#ef5050;">return</span> <span style="color:#0e6ead;">base</span> * <span style="color:#2d7a00;">power</span>(<span style="color:#0e6ead;">base</span>, <span style="color:#0e6ead;">exp</span>-<span style="color:#b45309;">1</span>); <span style="color:#6b7280;">// RECURSIVE</span></span>
    }<br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d"</span>, <span style="color:#2d7a00;">power</span>(<span style="color:#b45309;">2</span>, <span style="color:#b45309;">4</span>));
  </div>
