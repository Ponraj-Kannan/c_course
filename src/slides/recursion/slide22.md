<script setup>
const contents = [
  { text: '<b>Problem:</b> Write a recursive function to find the sum of digits of a given number.' },
  { text: '<b>Input:</b> <code>n = 1234</code>' },
  { text: '<b>Expected Output:</b> <code>Sum of digits = 10</code>  (1 + 2 + 3 + 4)' },
  { text: '<b>Note:</b> Use recursion only. Do not use a loop or convert the number to a string. Return type: <code>int</code>.', highlight: true },
