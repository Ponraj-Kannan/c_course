...
<div class="flex-col">
  ...
  <div v-click class="card" style="display:flex;gap:10px;align-items:center;border:1px solid var(--orange);">
    ...
    <div>
      ...
      <div class="small-text">Tower of Hanoi needs ~5 lines recursively in C — dozens iteratively.</div>
    </div>
  </div>
...
<div class="flex-col">
  ...
  <div v-after class="g2" style="gap:8px;">
    <div class="flex-col">
      ...
      <div class="code-block" style="font-size:.68rem;">
        <span style="color:#0e6ead;">int</span> <span style="color:#2d7a00;">fact_loop</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">n</span>) {<br>
        <span style="padding-left:16px;display:block;"><span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">result</span> = <span style="color:#b45309;">1</span>;</span>
        <span style="padding-left:16px;display:block;"><span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">i</span>=<span style="color:#b45309;">1</span>; <span style="color:#0e6ead;">i</span>&lt;=<span style="color:#0e6ead;">n</span>; <span style="color:#0e6ead;">i</span>++)</span>
    ...
    <div class="flex-col">
      ...
      <div class="code-block" style="font-size:.68rem;">
        <span style="color:#0e6ead;">int</span> <span style="color:#2d7a00;">fact_rec</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">n</span>) {<br>
        ...
        <span style="padding-left:16px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#0e6ead;">n</span> * <span style="color:#2d7a00;">fact_rec</span>(<span style="color:#0e6ead;">n</span>-<span style="color:#b45309;">1</span>);</span>
        }
      </div>
    </div>
  </div>
  ...
  <div v-click class="section-label" style="margin-top:6px;">Best-Use Cases for Recursion in C</div>
  <div v-after style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px;">
    <span class="pill pill-blue">Tree traversal</span>
    <span class="pill pill-green">Merge Sort</span>
