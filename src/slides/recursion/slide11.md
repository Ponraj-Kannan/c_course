...
<div class="flex-col">
  ...
  <div v-after class="code-block">
    <span style="color:#0e6ead;">void</span> <span style="color:#2d7a00;">countdown</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">n</span>) {<br>
    ...
    <span style="padding-left:20px;display:block;"><span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d "</span>, <span style="color:#0e6ead;">n</span>);</span>
    <span style="padding-left:20px;display:block;"><span style="color:#2d7a00;">countdown</span>(<span style="color:#0e6ead;">n</span> - <span style="color:#b45309;">1</span>); <span style="color:#6b7280;">// calls itself!</span></span>
    }<br>
    <span style="color:#2d7a00;">countdown</span>(<span style="color:#b45309;">3</span>);
  </div>
  ...
  <div v-after class="code-block">
    <span style="color:#0e6ead;">int</span> <span style="color:#2d7a00;">digitSum</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">n</span>) {<br>
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">if</span> (<span style="color:#0e6ead;">n</span> == <span style="color:#b45309;">0</span>)</span>
    <span style="padding-left:40px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#b45309;">0</span>;</span>
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#0e6ead;">n</span> % <span style="color:#b45309;">10</span> + <span style="color:#2d7a00;">digitSum</span>(<span style="color:#0e6ead;">n</span> / <span style="color:#b45309;">10</span>);</span>
    }<br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d"</span>, <span style="color:#2d7a00;">digitSum</span>(<span style="color:#b45309;">123</span>));
  </div>
