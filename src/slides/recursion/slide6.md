...
<div class="flex-col">
  ...
  <div v-click class="code-block" style="margin-top:4px;">
    ...
    <span style="color:#2d7a00;">factorial</span>(<span style="color:#b45309;">3</span>);
  </div>

  <div v-click class="callout callout-warn" style="font-size:.7rem;">
    <div><strong>Stack overflow risk!</strong> Deep recursion fills up the stack. In C, the default stack size is limited (often 1–8 MB). Unlike Python, there is no automatic error — your program may just crash.</div>
  </div>
