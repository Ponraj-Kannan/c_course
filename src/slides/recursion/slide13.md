...
<div class="flex-col">
  ...
  <div v-after class="code-block" style="font-size:.7rem;">
    ...
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#0e6ead;">n</span> * <span style="color:#2d7a00;">factorial</span>(<span style="color:#0e6ead;">n</span>-<span style="color:#b45309;">1</span>);</span>
...
<div class="flex-col">
  ...
  <div v-after class="code-block">
    ...
    <span style="color:#0e6ead;">int</span> <span style="color:#2d7a00;">factorial</span>(<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">n</span>, <span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">acc</span>) {<br>
    ...
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#2d7a00;">factorial</span>(<span style="color:#0e6ead;">n</span>-<span style="color:#b45309;">1</span>, <span style="color:#0e6ead;">n</span>*<span style="color:#0e6ead;">acc</span>); <span style="color:#6b7280;">// LAST op</span></span>
    }<br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d"</span>, <span style="color:#2d7a00;">factorial</span>(<span style="color:#b45309;">5</span>, <span style="color:#b45309;">1</span>));
  </div>
  ...
  <div v-click class="callout callout-info" style="font-size:.7rem; margin-bottom:40px;">
    <div><strong>Note:</strong> GCC can optimize tail recursion with <span class="mono">-O2</span> flag. This converts the call into a loop internally, saving stack space.</div>
  </div>
</div>
