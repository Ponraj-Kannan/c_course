...
<div class="flex-col">
  ...
  <div v-click class="code-block" style="font-size:.78rem;line-height:2;">
    <span style="color:#0e6ead;">return_type</span> <span style="color:#2d7a00;">function_name</span>(<span style="color:#c49a00;">parameters</span>) {<br>
    ...
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">return</span> <span style="color:#2d7a00;">function_name</span>(<span style="color:#0e6ead;">smaller_input</span>);</span>
    }
  </div>
</div>
<div class="flex-col">
  ...
  <div style="margin-top:4px; border:1px solid #e1e4e808; padding:10px; border-radius:10px;">
    ...
    <div style="display:flex;flex-direction:column;gap:5px;">
      <div style="display:flex;gap:8px;align-items:center;"  v-click>
        ...
        <span class="body-text">Data type the function returns (int, void…)</span>
      </div>
      <div style="display:flex;gap:8px;align-items:center;" v-click>
