---
theme: default
title: C Language Looping Statements
titleTemplate: '%s — C Fundamentals'
highlighter: shiki
lineNumbers: true
drawings:
  persist: false
...
<div class="flex-col">
  ...
  <div v-click class="callout callout-warn">
    <div><strong>Without a loop:</strong> Printing 1 to 100 requires 100 printf() statements. With a loop — just 4 lines!</div>
  </div>

  <div v-click class="card card-red" style="margin-top:4px;">
    <div class="slide-h3" style="margin-bottom:6px;">Real-World Analogy</div>
    <div class="body-text">A traffic signal repeats its Green → Yellow → Red cycle <strong>continuously</strong> until power is cut. That is exactly what a loop does in code.</div>
  </div>
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-size:.7rem;line-height:1.8;">
    ...
    <div><span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d\n"</span>, <span style="color:#b45309;">1</span>);</div>
    <div><span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d\n"</span>, <span style="color:#b45309;">2</span>);</div>
    <div><span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d\n"</span>, <span style="color:#b45309;">3</span>);</div>
    <div style="color:#6b7280;">... 97 more lines ...</div>
    <br>
    <div style="color:#6b7280;">/* With loop — clean and smart! */</div>
    <div><span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">i</span> = <span style="color:#b45309;">1</span>; <span style="color:#0e6ead;">i</span> &lt;= <span style="color:#b45309;">100</span>; <span style="color:#0e6ead;">i</span>++) {</div>
    <div style="padding-left:20px;"><span style="color:#2d7a00;">printf</span>(<span style="color:#b45309;">"%d\n"</span>, <span style="color:#0e6ead;">i</span>);</div>
    <div>}</div>
  </div>

  <div v-click class="card card-blue" style="margin-top:6px;">
    <div class="small-text"><strong>Types of Loops in C:</strong></div>
    <div style="display:flex;gap:8px;margin-top:6px;flex-wrap:wrap;">
      <span class="pill pill-red">while loop</span>
      <span class="pill pill-blue">do-while loop</span>
      <span class="pill pill-green">for loop</span>
    </div>
  </div>
</div>
