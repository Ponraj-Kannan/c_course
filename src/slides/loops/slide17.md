...
<!-- ═══════════════════════════════════════════════════════
     SLIDE 17 — break AND continue STATEMENTS
═══════════════════════════════════════════════════════ -->
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    <span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">i</span> = <span style="color:#b45309;">1</span>; <span style="color:#0e6ead;">i</span> &lt;= <span style="color:#b45309;">10</span>; <span style="color:#0e6ead;">i</span>++) {<br>
  ...
  <div v-click style="margin-top:8px;">
    ...
    <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
      <div class="flow-node flow-start" style="width:130px;">for i in 1..10</div>
      ...
      <div style="display:flex;gap:20px;">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
          ...
          <div class="flow-arrow">&#x25BC;</div>
          <div class="flow-node flow-body" style="width:90px;font-size:.65rem;">printf(i)</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    <span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> <span style="color:#0e6ead;">i</span> = <span style="color:#b45309;">1</span>; <span style="color:#0e6ead;">i</span> &lt;= <span style="color:#b45309;">8</span>; <span style="color:#0e6ead;">i</span>++) {<br>
  ...
  <div v-click style="margin-top:8px;">
    ...
    <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
      <div class="flow-node flow-start" style="width:130px;">for i in 1..8</div>
      <div class="flow-arrow">&#x25BC;</div>
