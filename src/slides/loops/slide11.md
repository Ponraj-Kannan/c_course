...
<script setup>
const contents = [
  { text: '<b>Problem:</b> Print the multiplication table of 7 for numbers 1 through 10 using a <b>for</b> loop.' },
  ...
  {
    text: '<b>Note:</b> Use a <b>for</b> loop with <code>i</code> from <code>1</code> to <code>10</code>. For each value of <code>i</code>, calculate <code>7 * i</code> and print it in the format <code>7 x i = result</code> using <code>printf()</code>.'
  },
]
</script>
