...
<!-- ═══════════════════════════════════════════════════════
     SLIDE 22 — ASSIGNMENT OPERATORS (C Language)
═══════════════════════════════════════════════════════ -->
  ...
  <div>
    <table class="cmp-table" style="font-size:.7rem;margin-top:6px;">
      ...
      <tbody>
        ...
        <tr v-click><td class="mono" style="color:var(--red-dark);font-weight:700;">/=</td><td class="mono">x /= 2;</td><td class="mono">x = x / 2;</td></tr>
        <tr v-click><td class="mono" style="color:var(--red-dark);font-weight:700;">%=</td><td class="mono">x %= 3;</td><td class="mono">x = x % 3;</td></tr>
        <tr v-click><td class="mono" style="color:var(--red-dark);font-weight:700;">&=</td><td class="mono">x &= 5;</td><td class="mono">x = x & 5;</td></tr>
        <tr v-click><td class="mono" style="color:var(--red-dark);font-weight:700;">|=</td><td class="mono">x |= 2;</td><td class="mono">x = x | 2;</td></tr>
      </tbody>
    </table>
  </div>
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:12px 14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    ...
    <span style="color:#0e6ead;">x</span> %= <span style="color:#b45309;">4</span>;  <span style="color:#6b7280;">// x is now 2</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">x</span>);  <span style="color:#6b7280;">// 2</span>
  </div>
  ...
  <div style="margin-top:8px; margin-bottom:40px">
    ...
    <table class="trace-table">
      ...
      <tbody>
        ...
        <tr v-click><td class="mono">x %= 4;</td><td class="mono h2">2</td></tr>
      </tbody>
    </table>
  </div>
</div>
