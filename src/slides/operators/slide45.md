...
<!-- ═══════════════════════════════════════════════════════
     SLIDE 21 — ARITHMETIC OPERATORS (C Language)
═══════════════════════════════════════════════════════ -->
  ...
  <div>
    <table class="cmp-table" style="font-size:.72rem;margin-top:6px;">
      ...
      <tbody>
        ...
        <tr v-click><td class="mono" style="color:var(--red-dark);font-weight:700;">/</td><td>Division</td><td class="mono">10 / 3</td><td class="mono yes">3</td></tr>
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:12px 14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    ...
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">a</span> + <span style="color:#0e6ead;">b</span>);  <span style="color:#6b7280;">// 13</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">a</span> - <span style="color:#0e6ead;">b</span>);  <span style="color:#6b7280;">// 7</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">a</span> * <span style="color:#0e6ead;">b</span>);  <span style="color:#6b7280;">// 30</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">a</span> / <span style="color:#0e6ead;">b</span>);  <span style="color:#6b7280;">// 3   ← integer division</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%d\n"</span>, <span style="color:#0e6ead;">a</span> % <span style="color:#0e6ead;">b</span>);  <span style="color:#6b7280;">// 1   ← remainder</span><br>
    <span style="color:#6b7280;">// Float division: cast first</span><br>
    <span style="color:#2d7a00;">printf</span>(<span style="color:#2d7a00;">"%.2f\n"</span>, (<span style="color:#ef5050;">float</span>)<span style="color:#0e6ead;">a</span> / <span style="color:#0e6ead;">b</span>); <span style="color:#6b7280;">// 3.33</span>
  </div>

  <div v-click class="callout callout-info" style="margin-top:6px;">
    <div><strong>Note:</strong> In C, <span class="mono">/</span> on two <span class="mono">int</span> values gives an integer result (truncates). To get a decimal, cast to <span class="mono">float</span> first. The <span class="mono">%</span> operator works only on integers and is handy for even/odd: <span class="mono">n % 2 == 0</span>.</div>
  </div>
